            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: Text(questionText.toString(), style: TextStyle(color: Theme.of(context).colorScheme.tertiary, fontWeight: FontWeight.bold, fontSize: 28),
                    ),
                  ),
                ],
              ),
                ...
                child: ClipRRect(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Theme.of(context).colorScheme.primary,
                      side: selected == 2 ? const BorderSide(color: Color.fromARGB(255, 102, 102, 255), width: 3) : BorderSide(color: Theme.of(context).colorScheme.primary, width: 3),
                    ),
                    child: Center(child: Text(answer2.toString(), style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      fontSize: 30
                      ))),
                ...
                child: ClipRRect(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Theme.of(context).colorScheme.primary,
                      side: selected == 3 ? const BorderSide(color: Color.fromARGB(255, 102, 102, 255), width: 3) : BorderSide(color: Theme.of(context).colorScheme.primary, width: 3),
                    ),
                    child: Center(child: Text(answer3.toString(), style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      fontSize: 30
                      ))),
                ...
                child: ClipRRect(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Theme.of(context).colorScheme.primary,
                      side: selected == 4 ? const BorderSide(color: Color.fromARGB(255, 102, 102, 255), width: 3) : BorderSide(color: Theme.of(context).colorScheme.primary, width: 3),
                    ),
                    child: Center(child: Text(answer4.toString(), style: const TextStyle(
                      color: Colors.white,
                      fontWeight: FontWeight.bold,
                      fontSize: 30
                      ))),
